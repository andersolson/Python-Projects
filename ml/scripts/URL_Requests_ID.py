...
# create logger
logFile = os.path.dirname(os.path.abspath(__file__)) + os.sep + "NAIPtoImageID_1.log"
...
# Input shapefile
zipSHP = r'D:\Projects\WORKING\ML\vectors\National_WW\ID_WW_Merge_1.zip'
...
save_dir = r'B:/projects/FirebreakML/Firebreak_Water_Wildland/imagery/ID_Water_Wildland'
