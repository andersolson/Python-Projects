...
def get_save_url(x):
    ...
    #url = """https://securewatch.maxar.com/mapservice/wmsaccess?connectId=c8475cb2-647b-44a2-a2dd-a9ccf2dbcbbc&SERVICE=WMS&REQUEST=GetMap&version=1.1.1&SRS=EPSG:3857&BBOX={}&WIDTH=1102&HEIGHT=712&LAYERS=DigitalGlobe:Imagery&format=image/jpeg"""
