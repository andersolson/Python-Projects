...
# Run in QGIS manually (2 hours 1 minute 31 seconds)

# Copy as Python Command
processing.run("native:zonalstatisticsfb", {'INPUT':'D:/Projects/WORKING/pheonix/vectors/multibuffer/CA_By_County.gdb|layername=T23_0','INPUT_RASTER':'D:/Projects/WORKING/pheonix/imagery/ca_mosaic/mosaic_06023.tif','RASTER_BAND':1,'COLUMN_PREFIX':'_zonal','STATISTICS':[0,1,2],'OUTPUT':'D:/Projects/WORKING/pheonix/vectors/zonalstats_csv/testa_030623.csv'})

# Copy as QGIS process command
qgis_process run native:zonalstatisticsfb --distance_units=meters --area_units=m2 --ellipsoid=EPSG:7030 --INPUT='D:/Projects/WORKING/pheonix/vectors/multibuffer/CA_By_County.gdb|layername=T23_0' --INPUT_RASTER='D:/Projects/WORKING/pheonix/imagery/ca_mosaic/mosaic_06023.tif' --RASTER_BAND=1 --COLUMN_PREFIX=_zonal --STATISTICS=0 --STATISTICS=1 --STATISTICS=2 --OUTPUT='D:/Projects/WORKING/pheonix/vectors/zonalstats_csv/testa_030623.csv'

# Run as a gdal process: https://pcjericks.github.io/py-gdalogr-cookbook/raster_layers.html#calculate-zonal-statistics
